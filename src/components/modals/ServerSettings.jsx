        ...
        <div className="overflow-y-auto custom-scrollbar pr-2">
          ...
          <div className="bg-[#1c1e22] p-5 rounded-2xl border border-[#23252a] shadow-sm">
            ...
            <div className="flex flex-col gap-3 pt-4 border-t border-[#23252a]">
              <button type="button" onClick={handleUpdate} className="w-full bg-indigo-500 text-white py-4 md:py-3 rounded-xl font-bold hover:bg-indigo-600 transition-all shadow-lg cursor-pointer flex items-center justify-center gap-2">
                <Save size={18} /> Save Changes
              </button>
              
              <div className="flex flex-col md:flex-row gap-3">
                <button type="button" onClick={onClose} className="flex-1 bg-white/5 hover:bg-white/10 text-gray-300 py-4 md:py-3 rounded-xl font-bold transition-all cursor-pointer hidden md:block">Cancel</button>
                <button type="button" onClick={handleDelete} className="flex-1 bg-red-500/10 hover:bg-red-500/20 text-red-400 py-4 md:py-3 rounded-xl font-bold transition-all cursor-pointer flex items-center justify-center gap-2 border border-red-500/20">
