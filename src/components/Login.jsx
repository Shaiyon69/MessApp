      ...
      <div className="w-full md:w-1/2 p-8 pt-safe md:p-10 lg:p-14 flex flex-col justify-center md:justify-between border-b md:border-b-0 md:border-r border-[#23252a] relative shrink-0">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-2 md:mb-6 font-display leading-[1.1]">
            ...
            <span className="md:hidden"> </span>without<br className="hidden md:block"/>
            <span className="md:hidden"> </span>the mess.
          </h1>
        ...
        <div className="max-w-md w-full mx-auto my-auto md:my-0">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5 md:gap-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 md:mt-2 w-full h-14 md:h-auto md:py-4 bg-gradient-to-r from-indigo-300 to-indigo-600 text-[#0d0f12] rounded-xl font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {loading ? (
          ...
          <div className="flex items-center gap-4 my-6 md:my-8">
            ...
            <span className="text-[10px] md:text-xs font-bold text-gray-500 uppercase tracking-widest">New to the app?</span>
            <div className="flex-1 h-[1px] bg-gray-800"></div>
          </div>
